...
constant TOTAL_OPS : type_array_TOTAL_OPS := (2700, 10);
type type_array_X_SIZE is array (0 to 1) of integer;
constant X_SIZE : type_array_X_SIZE := (32, 2700);
type type_array_CONVS_PER_LINE is array (0 to 1) of integer;
constant CONVS_PER_LINE : type_array_CONVS_PER_LINE := (30, 10);
...
constant IN_FEATURES : type_array_IN_FEATURES := (3072, 2700);
type type_array_OUT_FEATURES is array (0 to 1) of integer;
constant OUT_FEATURES : type_array_OUT_FEATURES := (2700, 10);
