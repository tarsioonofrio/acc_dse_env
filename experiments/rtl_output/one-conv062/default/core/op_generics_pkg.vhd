...
constant TOTAL_OPS : type_array_TOTAL_OPS := (3600);
type type_array_X_SIZE is array (0 to 0) of integer;
constant X_SIZE : type_array_X_SIZE := (62);
type type_array_CONVS_PER_LINE is array (0 to 0) of integer;
constant CONVS_PER_LINE : type_array_CONVS_PER_LINE := (60);
...
constant IN_FEATURES : type_array_IN_FEATURES := (3844);
type type_array_OUT_FEATURES is array (0 to 0) of integer;
constant OUT_FEATURES : type_array_OUT_FEATURES := (3600);
