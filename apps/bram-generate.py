...
def main():
    ...
    with open(Path(__file__).parent.resolve() / "lib/template/config_const_array.vhd", "r") as f:
    ...
    with open(Path(__file__).parent.resolve() / "lib/template/config_const_pkg.vhd", "r") as f:
