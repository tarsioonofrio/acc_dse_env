...
write_db ./results/${CLK_PERIOD}ns/${INPUT_SIZE}bit/${ARRAY_TYPE}_${DATAFLOW_TYPE}/layer${LAYER}/${ARRAY_TYPE}_${DATAFLOW_TYPE}_pre_cts.dat
...
# Save design
write_db ./results/${CLK_PERIOD}ns/${INPUT_SIZE}bit/${ARRAY_TYPE}_${DATAFLOW_TYPE}/layer${LAYER}/${ARRAY_TYPE}_${DATAFLOW_TYPE}_pos_cts.dat
...
write_db ./results/${CLK_PERIOD}ns/${INPUT_SIZE}bit/${ARRAY_TYPE}_${DATAFLOW_TYPE}/layer${LAYER}/${ARRAY_TYPE}_${DATAFLOW_TYPE}_pos_route.dat
...
write_db ./results/${CLK_PERIOD}ns/${INPUT_SIZE}bit/${ARRAY_TYPE}_${DATAFLOW_TYPE}/layer${LAYER}/${ARRAY_TYPE}_${DATAFLOW_TYPE}_pos_fix_fan.dat  
...
write_db ./results/${CLK_PERIOD}ns/${INPUT_SIZE}bit/${ARRAY_TYPE}_${DATAFLOW_TYPE}/layer${LAYER}/${ARRAY_TYPE}_${DATAFLOW_TYPE}_pos_opt.dat
...
write_db ./results/${CLK_PERIOD}ns/${INPUT_SIZE}bit/${ARRAY_TYPE}_${DATAFLOW_TYPE}/layer${LAYER}/${ARRAY_TYPE}_${DATAFLOW_TYPE}_pos_filler.dat
...
write_netlist ./results/${CLK_PERIOD}ns/${INPUT_SIZE}bit/${ARRAY_TYPE}_${DATAFLOW_TYPE}/layer${LAYER}/outputs/${ARRAY_TYPE}_${DATAFLOW_TYPE}.v

# Generate outputs
#create_clock -name {clk_in} -period 1 [get_ports {clk_in}]
extract_rc 
write_sdc ./results/${CLK_PERIOD}ns/${INPUT_SIZE}bit/${ARRAY_TYPE}_${DATAFLOW_TYPE}/layer${LAYER}/outputs/${ARRAY_TYPE}_${DATAFLOW_TYPE}.sdc
write_sdf ./results/${CLK_PERIOD}ns/${INPUT_SIZE}bit/${ARRAY_TYPE}_${DATAFLOW_TYPE}/layer${LAYER}/outputs/${ARRAY_TYPE}_${DATAFLOW_TYPE}.sdf
write_def -floorplan -netlist -routing ./results/${CLK_PERIOD}ns/${INPUT_SIZE}bit/${ARRAY_TYPE}_${DATAFLOW_TYPE}/layer${LAYER}/outputs/${ARRAY_TYPE}_${DATAFLOW_TYPE}.def

# Generate reports
report_summary -out_dir  ./results/${CLK_PERIOD}ns/${INPUT_SIZE}bit/${ARRAY_TYPE}_${DATAFLOW_TYPE}/layer${LAYER}/summaryReport
report_power   -out_file ./results/${CLK_PERIOD}ns/${INPUT_SIZE}bit/${ARRAY_TYPE}_${DATAFLOW_TYPE}/layer${LAYER}/reports/${ARRAY_TYPE}_${DATAFLOW_TYPE}_power.txt -cap
report_area > ./results/${CLK_PERIOD}ns/${INPUT_SIZE}bit/${ARRAY_TYPE}_${DATAFLOW_TYPE}/layer${LAYER}/reports/${ARRAY_TYPE}_${DATAFLOW_TYPE}_area.txt
report_nets > ./results/${CLK_PERIOD}ns/${INPUT_SIZE}bit/${ARRAY_TYPE}_${DATAFLOW_TYPE}/layer${LAYER}/reports/${ARRAY_TYPE}_${DATAFLOW_TYPE}_nets.txt

set_db timing_analysis_check_type hold
report_timing > ./results/${CLK_PERIOD}ns/${INPUT_SIZE}bit/${ARRAY_TYPE}_${DATAFLOW_TYPE}/layer${LAYER}/reports/${ARRAY_TYPE}_${DATAFLOW_TYPE}_hold.txt

set_db timing_analysis_check_type setup
report_timing > ./results/${CLK_PERIOD}ns/${INPUT_SIZE}bit/${ARRAY_TYPE}_${DATAFLOW_TYPE}/layer${LAYER}/reports/${ARRAY_TYPE}_${DATAFLOW_TYPE}_setup.txt
