...
vlog ../../psynth/28nm/results/${CLK_PERIOD}ns/${INPUT_SIZE}bit/syst2d_ws/layer${LAYER}/outputs/syst2d_ws.v
...
# Simulate the design.
onerror {resume}
vsim -t ps -sdfmax /tb/DUT=../../psynth/28nm/results/${CLK_PERIOD}ns/${INPUT_SIZE}bit/syst2d_ws/layer${LAYER}/outputs/syst2d_ws.sdf tb -f ../../apps/generic_file.txt
vcd file syst2d_ws_${LAT}.vcd
vcd add -r /tb/DUT/*
