...
vlog ../../psynth/28nm/results/${CLK_PERIOD}ns/${INPUT_SIZE}bit/syst2d_is_slice_buf_hier/layer${LAYER}/outputs/syst2d_is_slice_buf_hier.v
...
# Simulate the design.
onerror {resume}
vsim -t ps -sdfmax /tb/DUT/syst2d=../../psynth/28nm/results/${CLK_PERIOD}ns/${INPUT_SIZE}bit/syst2d_is_slice_buf_hier/layer${LAYER}/outputs/syst2d_is_slice_buf_hier.sdf tb -f ../../apps/generic_file.txt
vcd file syst2d_is_slice_buf_hier_${LAT}.vcd
vcd add -r /tb/DUT/*
