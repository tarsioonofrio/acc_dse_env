...
vlog ../../psynth/28nm/results/${CLK_PERIOD}ns/${INPUT_SIZE}bit/syst2d_os/layer${LAYER}/outputs/syst2d_os.v
...
# Simulate the design.
onerror {resume}
vsim -t ps -sdfmax /tb/DUT=../../psynth/28nm/results/${CLK_PERIOD}ns/${INPUT_SIZE}bit/syst2d_os/layer${LAYER}/outputs/syst2d_os.sdf tb -f ../../apps/generic_file.txt
vcd file syst2d_os_${LAT}.vcd
vcd add -r /tb/DUT/*
