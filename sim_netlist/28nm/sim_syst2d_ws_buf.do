...
vlog ../../psynth/28nm/results/${CLK_PERIOD}ns/${INPUT_SIZE}bit/syst2d_ws_buf/layer${LAYER}/outputs/syst2d_ws_buf.v
...
# Simulate the design.
onerror {resume}
vsim -t ps -sdfmax /tb/DUT=../../psynth/28nm/results/${CLK_PERIOD}ns/${INPUT_SIZE}bit/syst2d_ws_buf/layer${LAYER}/outputs/syst2d_ws_buf.sdf tb -f ../../apps/generic_file.txt
vcd file syst2d_ws_buf_${LAT}.vcd
vcd add -r /tb/DUT/*
do wave_syst2d_ws_buf.do
onfinish exit
onbreak exit
run -all
