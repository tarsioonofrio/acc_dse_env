...
vlog ../../psynth/28nm/results/${CLK_PERIOD}ns/${INPUT_SIZE}bit/syst2d_is_slice/layer${LAYER}/outputs/syst2d_is_slice.v
...
# Simulate the design.
onerror {resume}
vsim -t ps -sdfmax /tb/DUT=../../psynth/28nm/results/${CLK_PERIOD}ns/${INPUT_SIZE}bit/syst2d_is_slice/layer${LAYER}/outputs/syst2d_is_slice.sdf tb -f ../../apps/generic_file.txt
vcd file syst2d_is_slice_${LAT}.vcd
vcd add -r /tb/DUT/*
do wave_syst2d_is_slice.do
onfinish exit
onbreak exit
run -all
